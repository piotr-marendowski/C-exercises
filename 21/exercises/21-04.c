...
{
    /*
    All of the following information has been taken directly from the ISO/IEC 9899:1999 standard (C99 standard).
    complex.h
    ...
    Lowercase letters which may be added to the conversion specifiers and length modifiers in fprintf and fscanf. gets is
    obsolescent and deprecated, and ungetc used on a binary stream where the file position indicated is zero prior to the call is obsolescent.
    stdlib.h
    ...
    Names beginning with wcs and a lowercase letter. Lowercase letters may be added to the conversion specifiers and length modifiers
    in fwprintf and fwscanf. Other characteres may be used in extensions.
    wctype.h
